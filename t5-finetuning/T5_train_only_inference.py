...
if __name__=='__main__':
    ...
    wandb.login()
    wandb.init(project='chatgpt_aug_t5_finetuning')
    ...
    #load dataset
    df = pd.read_csv(f"dataset/chatgpt_aug_finetuning.csv", sep=',')

    #load test dataset
    df2 = pd.read_csv(f"dataset/chatgpt_aug_finetuning.csv", sep=',')
    ...
    output_dir='chatgpt_aug_inference'
